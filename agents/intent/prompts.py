...
- 用户泛泛询问设备/仪器/产品是不是问题很多、是否经常坏、故障率/质量/稳定性/可靠性如何，且没有具体设备型号、故障现象、错误码、测试条件，也没有要求列举常见故障、排查步骤或解决方案时，走 casual_chat，reason 写 vague_domain_chat，dialog_act 写 topic_redirect，不要进入知识库检索。
